...
/** iPhone /about charts — sage bloom palette. */
export const PROTO_PHONE_CHART_COLORS = {
  accent: R.gold,
  accentWarm: R.copper,
  cool: "#A8C8B0",
  coolDeep: R.blue,
  track: "rgba(88, 144, 122, 0.22)",
  gridLine: "rgba(88, 144, 122, 0.14)",
  axis: "rgba(168, 200, 176, 0.42)",
  sliceMuted: "#A8C8B0",
  sliceMid: R.blue,
  donutCenter: R.deep,
...
export const PROTO_PHONE_CHART_GRADIENTS = {
  ...
  track: `linear-gradient(90deg, rgba(24, 40, 32, 0.42) 0%, rgba(88, 144, 122, 0.28) 55%, rgba(168, 200, 176, 0.22) 100%)`,
