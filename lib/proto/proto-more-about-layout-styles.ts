...
export const PROTO_MORE_ABOUT_CARD_PANEL_TW = `relative w-full overflow-hidden border border-[#2A3538] bg-[#151c1f] ${DOEPHONE_SECTION_CAROUSEL_RADIUS} aspect-[16/10] shadow-none`;
...
export const PROTO_MORE_ABOUT_CARD_TITLE_PHONE_TW = `mt-4 text-left font-normal leading-[1.2] tracking-[-0.015em] text-white text-[clamp(1.42rem,1.2rem+0.95vmin,1.78rem)] iphone-page:text-[clamp(1.52rem,1.28rem+1.05vmin,1.9rem)] ${PROTO_FONT_CLASS}`;
...
export const PROTO_MORE_ABOUT_CARD_META_PHONE_TW = `mt-2 text-left font-medium leading-[1.35] text-white/55 text-[clamp(1.18rem,1.02rem+0.7vmin,1.42rem)] iphone-page:text-[clamp(1.26rem,1.08rem+0.8vmin,1.5rem)] ${PROTO_FONT_CLASS}`;
