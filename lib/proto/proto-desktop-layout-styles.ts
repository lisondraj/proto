...
/** Bleed bands — full-width two-column grid; per-column gutters handle page margins. */
export const PROTO_DESKTOP_SPLIT_SECTION_GRID_BLEED =
  "grid h-full min-h-0 w-full grid-cols-2 py-8 md:py-10 lg:py-12";

/** Inner gutter between copy and edge-bleed panel — matches /about. */
...
export const PROTO_DESKTOP_SPLIT_BLEED_INNER_Y = "py-8 md:py-10 lg:py-12";
...
export const PROTO_DESKTOP_SPLIT_TEXT_COLUMN_LEFT_BLEED = `flex min-h-0 min-w-0 flex-col justify-center ${DOEPHONE_DESKTOP_PAGE_INSET_LEFT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_X_RIGHT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_Y}`;

export const PROTO_DESKTOP_SPLIT_TEXT_COLUMN_RIGHT_BLEED = `flex min-h-0 min-w-0 flex-col justify-center ${DOEPHONE_DESKTOP_PAGE_INSET_RIGHT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_X_LEFT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_Y}`;

export const PROTO_DESKTOP_SPLIT_BOX_COLUMN_RIGHT_BLEED = `grid min-h-0 min-w-0 h-full items-center justify-items-end ${DOEPHONE_DESKTOP_PAGE_INSET_RIGHT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_X_LEFT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_Y}`;

export const PROTO_DESKTOP_SPLIT_BOX_COLUMN_LEFT_BLEED = `grid min-h-0 min-w-0 h-full items-center justify-items-start ${DOEPHONE_DESKTOP_PAGE_INSET_LEFT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_X_RIGHT} ${PROTO_DESKTOP_SPLIT_BLEED_INNER_Y}`;
